...
# Your API endpoints are already designed to accept a date from the request.
...
def init_db():
    ...
    if cur.fetchone()["c"] == 0:
        students = [
            ...
            ("24820005","Hariharan"),
            ("24820006","Meenatchi"),
            ("24820007","Siva Bharathi"),
            ("24820008","Visal Stephen Raj"),
        ]
...
def api_student_report():
    ...
    # --- CHANGE IS HERE: Count present days ---
    ...
    return jsonify({
        ...
        "days_present": days_present  # --- And Here: Add count to response
    })
